...
image_dir = "C:/Users/lian/Desktop/coco128/images/train2017"
# image_dir = "D:/zm/coco128/images"

# 指定 labels 文件夹路径

# label_dir = "D:/zm/coco128/labels"
label_dir = "C:/Users/lian/Desktop/coco128/labels/train2017"
...
for i in tqdm(range(len(valid_images))):
    ...
    if r < 0.1:
        ...
        destination = "C:/Users/lian/PycharmProjects/yolov8/datasets/test"

    elif r < 0.2:

        # 移动到 valid 文件夹

        destination = "C:/Users/lian/PycharmProjects/yolov8/datasets/val"

    else:

        # 移动到 train 文件夹

        destination = "C:/Users/lian/PycharmProjects/yolov8/datasets/train"
